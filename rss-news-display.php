...
{
	add_option('rssnews_rss1', "http://www.gopiplus.com/work/feed");
...
function rssnews_admin_options() 
{
	...
	echo $rssnews_rss1 . '" name="rssnews_rss1" id="rssnews_rss1" /><br>';
	echo 'Slider Direction:<br><input  style="width: 200px;" maxlength="4" type="text" value="';
	...
	echo 'Slider Direction:<br><input  style="width: 200px;" maxlength="100" type="text" value="';
    ...
    <ul>
    <li><a href="http://www.gopiplus.com/work/2012/04/03/rss-news-display-wordpress-plugin/" target="_blank">Add directly in the theme</a></li>
    <li><a href="http://www.gopiplus.com/work/2012/04/03/rss-news-display-wordpress-plugin/" target="_blank">Add the news in the page using short code</a></li>
    <li>Check official website for live demo <a href="http://www.gopiplus.com/work/2012/04/03/rss-news-display-wordpress-plugin/" target="_blank">click here</a></li>
    </ul>
    <?php
}

add_filter('the_content','rssnews_show_filter');


# Function to call short code
function rssnews_show_filter($content)
{
	return 	preg_replace_callback('/\[RSS-NEWS-DISPLAY=(.*?)\]/sim','rssnews_show_filter_callback',$content);
}

# Function to filter short code
function rssnews_show_filter_callback($matches) 
{
	global $wpdb;
	//[RSS-NEWS-DISPLAY=1]
	$setting = $matches[1];
...
# Plugin hook
add_action('init', 'rssnews_add_javascript_files');
